...
Best existing fit is the `best-practices-k8s` library — `require-probes`, `require-requests-limits`, `require-rolling-update-strategy`, and `require-pod-antiaffinity` directly address DORA's operational resilience requirements.
